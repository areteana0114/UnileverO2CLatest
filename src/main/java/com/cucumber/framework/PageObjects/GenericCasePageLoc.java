...
public interface GenericCasePageLoc {
    ...
    String xpathend_namycases_caseid="]/td[2]";
...
//    String xpathend_MyWL_caseid= "']/td[1]";  
   ...
   // String xpath_filtercaseid_followedcase="//*[@id=\"$PD_pxFavorites_pa62572107302470pz$ppxResults$l1\"]/td[2]/div/span/a";
    ...
    String xpath_filtercaseid_nacaseid="//table[@pl_prop='pgRepPgSubSectionpyUserWorkListBBB.pxResults']/tbody/tr/th[2]/div/span/a[@id='pui_filter']";
    String xpath_searchtextinfilternamycaseidid="//input[@id='42294663']";
